...
namespace Lab9_V02_Business.Managers
{
    public class GroupManager : BaseManager
    {
        ...
        public void AddStudentToGroup(Student student, int groupId, bool hasDiscount)
        {
            ...
            student.IndividualPrice = hasDiscount ? group.BasePrice * (decimal)0.8 : group.BasePrice;
        ...
        /// <param name="groupId">Id группы</param>
        /// <returns></returns>
        public ICollection<Student> GetStudentsOfGroup(int groupId) => studentRepository.Find(s => s.GroupId == groupId).ToList();
    }
}
